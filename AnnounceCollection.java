...
public class AnnounceCollection extends AppCompatActivity {
 ...
 private sendingAnnounce sendingAnnounce = null;
    ...
    public boolean addannounce(Announce ano) {
       new sendingAnnounce(ano.getAnnounceId(),ano.getProduct(),ano.getPrice(),ano.getProfit(),ano.getLocation(),ano.getPostdatetime(),ano.getComment(),ano.getBuyerId());
   ...
   public sendingAnnounce(int announceId, String product, double price, double profit, String location, Date postdatetime, String comment, int bringerId) {
      ...
      this.buyerId = buyerId;
        ...
        private JSONObject constructJsonObject() {
            ...
            try {
                jsonObject.accumulate("A_ID", announceId);
                jsonObject.accumulate("A_PRODUCT", product);
                jsonObject.accumulate("A_POSTTIME", postdatetime);
                ...
                jsonObject.accumulate("BU_ID", buyerId);
