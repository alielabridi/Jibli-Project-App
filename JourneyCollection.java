...
public class JourneyCollection extends AppCompatActivity {
    ...
    public boolean addjourney(Journey ano) {
        new sendingJourney(ano.getJourneyID(),ano.getDate(),ano.getDest(),ano.getDepar());
   ...
   public sendingJourney(int journeyID, Date date, String dest, String depar) {
